    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialised lg:flex justify-center items-center">
      <section className="lg:flex">
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-green" href="https://www.webmotors.com.br/catalogo/carroceria/suv/" target="_blank">Ver mais</a>
        </div>
